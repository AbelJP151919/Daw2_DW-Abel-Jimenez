$(document).ready(function() {
    $('#formulario').on('submit', function(e) {
        ...
        */
        ...
        if (nombre === '' || email === '' || apellido === '' || DNI === '' || password === '' || password2 === '' || numero === '') {
        ...
        if (!esImpar(numero)){
            alert("Introduce un numero Impar porfavor.");
            return;
        }
        
        procesarFormulario(nombre, apellido, DNI, email, password, numero);
    });
    ...
    function procesarFormulario(nombre, apellido, DNI, email, password, numero) {
